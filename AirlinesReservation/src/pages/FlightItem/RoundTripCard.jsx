...
const RoundTripCard = ({ flight }) => {
    const formattedDepartureDate = format(new Date(flight.schedule.departure.departur), 'HH:mm, dd MMM yyyy');
    const formattedArrivalDate = format(new Date(flight.schedule.departure.destination), 'HH:mm, dd MMM yyyy');
    const formattedReturnDepartureDate = format(new Date(flight.schedule.return.departure), 'HH:mm, dd MMM yyyy');
    const formattedReturnArrivalDate = format(new Date(flight.schedule.return.destination), 'HH:mm, dd MMM yyyy');
    return (
            ...
            <div className="card-body p-4 pb-0">
                ...
                <div className="row g-4 pb-3">
                    <div className="col-md-3 col-sm-4">
                        ...
                        <p>{flight.details.departure_city || 'Unknown Origin'}</p>
                    </div>
                    ...
                    <div className="col-md-3 col-sm-4">
                        ...
                        <p>{flight.details.destination_city || 'Unknown Destination'}</p>
                    </div>
                ...
                <div className="row g-4 pb-3">
                    <div className="col-md-3 col-sm-4">
                        <h5 className="whitetxt"><strong>{formattedReturnDepartureDate}</strong></h5>
                        <p>{flight.details.destination_city || 'Unknown Destination'}</p> {/* Nơi đi cho chuyến bay về */}
                    </div>
                    ...
                    <div className="col-md-3 col-sm-4">
                        <h5 className="whitetxt"><strong>{formattedReturnArrivalDate}</strong></h5>
                        <p>{flight.details.departure_city || 'Unknown Destination'}</p> {/* Nơi đến cho chuyến bay về */}
                    </div>
                </div>
            </div>
        </div>
