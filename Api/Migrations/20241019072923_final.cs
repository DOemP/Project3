            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Image = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Posted_on = table.Column<DateTime>(type: "datetime(6)", nullable: false)
                },
                constraints: table =>
                {
...
.Annotation("MySql:CharSet", "utf8mb4")
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FlightType = table.Column<string>(type: "enum('Departure', 'Return')", nullable: false)
        .Annotation("MySql:CharSet", "utf8mb4"),
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FlightTimes_Flights_FlightID",
                        column: x => x.FlightID,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    FlightID = table.Column<int>(type: "int", nullable: false),
					TripType = table.Column<string>(type: "enum('Popular', 'Merchant')", nullable: false)
		.Annotation("MySql:CharSet", "utf8mb4"),
					TicketType = table.Column<string>(type: "enum('OneWay', 'RoundTrip', 'MultiStage')", nullable: false)
		.Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
					...
					Status = table.Column<int>(type: "enum('Pending', 'Completed')", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PositionSeat = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderDetails_Ticket_TicketId",
                        column: x => x.TicketId,
